...
output_dir = '../save/CV/accel_cbnet'
save_4_pt_box = True
...
train_batch_size = 4
try_test_epoch = [1, 5, 10, 50, 100, 150, 200, 250, 300, 350, 370, 390, 400, 410, 420, 430]
start_test_epoch = 430   #200    #相对值
test_inteval = 2
...
if lr_scheduler=='MultiStepLR':
    #MultiStepLR
    lr_gamma = 0.1
    lr_decay_step = [250, 400, 500]    #[250, 400]
