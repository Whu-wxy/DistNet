...
output_dir = '../save/abla_onlydist_IC15'
...
train_batch_size = 6
try_test_epoch = [0, 7, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 420, 440, 460, 470, 480]
start_test_epoch = 470      #绝对值
test_inteval = 2
always_test_threld = 0.65
