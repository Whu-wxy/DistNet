...
class FPN_ResNet_CARAFE(nn.Module):
    def __init__(self, backbone, result_num, scale: int = 1, pretrained=False, predict=False):
        ...
        self.out_up_CARAFE =  CARAFEPack(conv_out, 2, compressed_channels=64)
...
if __name__ == '__main__':
    ...
    backbone = 'resnet50'
    net = FPN_ResNet_CARAFE(backbone=backbone, pretrained=False, result_num=5, predict=False).to(device)
    net.eval()
