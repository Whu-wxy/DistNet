...
output_dir = '../save/CV/dlaseg'
save_4_pt_box = True
eval_script = 'iou'   # deteval, iou, 2013
data_shape = 640    # 640

long_size = 640  # 2240/None
img_norm = False
...
train_batch_size = 4
try_test_epoch = [1, 10, 50, 100, 150, 200, 250, 300, 350, 360, 370, 380, 390, 400, 410, 420]
